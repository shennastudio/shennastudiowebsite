...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>Dolphins also serve as indicator species—their health reflects the overall health of the marine environment. Because they're long-lived, produce few offspring, and accumulate toxins in their tissues, dolphin populations are particularly sensitive to pollution, habitat degradation, and prey depletion. Monitoring dolphin health provides early warning signs of ecosystem problems.</p>
