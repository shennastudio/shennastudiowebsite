...
export const metadata: Metadata = {
  ...
  description: 'Partner with ShennaStudio for wholesale ocean-inspired jewelry. Competitive wholesale pricing, low MOQs, and 10% of sales donated to marine conservation. Perfect for boutiques, gift shops, and retailers.',
