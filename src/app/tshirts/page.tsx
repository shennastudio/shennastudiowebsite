...
export default async function TShirtsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <AnimatedSection animation="fadeInDown" className="text-center">
            ...
            <p className="text-xl text-pink-100 max-w-2xl mx-auto mb-8">
              {products.length > 0
                ? `${products.length} unique designs available`
                : 'Coming soon - beautiful ocean-themed t-shirts'}
            </p>
          </AnimatedSection>
        </div>
      </section>
          ...
          {products.length === 0 ? (
            <AnimatedSection animation="fadeInUp" className="text-center py-20">
              <div className="max-w-2xl mx-auto">
                <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 dark:from-purple-950/30 dark:via-pink-950/30 dark:to-rose-950/30 border-2 border-purple-200 dark:border-purple-800 rounded-3xl p-12 shadow-lg">
                  ...
                  <p className="text-xl text-gray-700 dark:text-gray-300 mb-6">
                    Ocean-inspired T-Shirts are on the way!
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-8">
                    We&apos;re working on bringing you beautiful ocean-themed t-shirts that support marine conservation.
                  ...
                  <Link
                    href="/products"
                    className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:from-purple-600 hover:to-pink-600 transition-all transform hover:scale-105 shadow-lg"
                  >
                    <span>📿</span>
                    Shop Bracelets Now
                  </Link>
            ...
            <StaggeredChildren className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8" staggerDelay={100}>
              {products.map((product) => {
                ...
                return (
                  <div
                    key={product.id}
                    className="stagger-child bg-white dark:bg-slate-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-purple-100 dark:border-purple-900 group hover:-translate-y-2"
                  >
                    {/* Product Image */}
                    <div className="relative h-64 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 overflow-hidden">
                      {displayImage ? (
                        <Image
                          src={displayImage}
                          alt={product.name}
                    ...
                    <div className="p-6">
                        ...
                        <div className="mb-4">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {[...new Set(product.variants.map(v => v.size).filter(Boolean))].map((size) => (
                              <span
                                key={size}
                                className="px-2 py-1 bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 rounded text-xs font-medium"
                              >
                                {size}
                              </span>
                            ))}
                      ...
                      <Link
                        ...
                        className="block w-full text-center bg-purple-600 hover:bg-purple-700 text-white py-3 rounded-lg transition-all transform hover:scale-105 font-semibold"
                      >
                        View Details
                      </Link>
                    </div>
      ...
      <section className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 py-12 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-16 h-16 rounded-full bg-purple-500 animate-ping" style={{ animationDuration: '4s' }} />
          <div className="absolute top-1/2 right-20 w-12 h-12 rounded-full bg-pink-500 animate-ping" style={{ animationDuration: '5s', animationDelay: '1s' }} />
          <div className="absolute bottom-20 left-1/3 w-8 h-8 rounded-full bg-rose-500 animate-ping" style={{ animationDuration: '6s', animationDelay: '2s' }} />
        </div>
          ...
          <AnimatedSection animation="fadeInUp">
            <div className="flex justify-center items-center gap-3 mb-4">
              ...
              <h2 className="text-3xl font-bold text-purple-700 dark:text-purple-300">
                Wear Your Support for Ocean Life
              </h2>
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
              Every t-shirt purchase supports sea turtle conservation, whale protection,
              and marine ecosystem restoration in South Padre Island and Rio Grande Valley.
            </p>
            <Link
              href="/conservation"
              className="inline-block border-2 border-purple-600 dark:border-purple-400 text-purple-600 dark:text-purple-400 px-8 py-3 rounded-full font-semibold hover:bg-purple-600 hover:text-white dark:hover:bg-purple-400 dark:hover:text-slate-900 transition-all transform hover:scale-105"
            >
