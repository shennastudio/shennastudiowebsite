...
export default async function TShirtsPage() {
 ...
 <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 border-2 border-purple-200 rounded-3xl p-12 shadow-lg">
 ...
 <div
 key={product.id}
 className="stagger-child bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-purple-100 group hover:-translate-y-2"
 >
 {/* Product Image */}
 ...
 <section className="bg-gradient-to-br from-purple-50 to-pink-50 py-12 relative overflow-hidden">
 ...
 <Link
 href="/conservation"
 className="inline-block border-2 border-purple-600 text-purple-600 px-8 py-3 rounded-full font-semibold hover:bg-purple-600 hover:text-white transition-all transform hover:scale-105"
 >
