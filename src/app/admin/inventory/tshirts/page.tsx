...
export default function TShirtInventoryPage() {
 ...
 <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 rounded-lg text-xs sm:text-sm">
 ...
 <p className="text-gray-600">No t-shirts found</p>
 </div>
 ) : (
 filteredTshirts.map((tshirt) => (
 <div key={tshirt.productId} className="border border-gray-200 rounded-lg p-4">
 <div className="flex items-center justify-between mb-4">
 <h3 className="font-semibold text-lg text-gray-900">{tshirt.productName}</h3>
 ...
 <DialogHeader>
 <DialogTitle className="text-gray-900">Adjust Stock</DialogTitle>
