        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
          {loadingSubscribers ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 dark:text-gray-400">No active subscribers found</p>
            </div>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead className="bg-gray-50 dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700">
                  <tr>
                    <th className="px-6 py-4 font-medium text-gray-900 dark:text-white">Subscriber</th>
                    <th className="px-6 py-4 font-medium text-gray-900 dark:text-white">Plan</th>
                    <th className="px-6 py-4 font-medium text-gray-900 dark:text-white">Status</th>
                    <th className="px-6 py-4 font-medium text-gray-900 dark:text-white">Billing Date</th>
                    <th className="px-6 py-4 font-medium text-gray-900 dark:text-white">Joined</th>
