...
export default function AbandonedCartsPage() {
 ...
 <Button variant="outline" onClick={() => loadCarts()} className="">
 ...
 <Card className="bg-gradient-to-br from-orange-50 to-amber-100 border-orange-100">
 ...
 <h3 className="text-2xl font-bold text-gray-900">{stats.totalAbandoned}</h3>
 <p className="text-sm text-gray-600">Abandoned Carts</p>
 </CardContent>
 </Card>

 <Card className="bg-gradient-to-br from-red-50 to-rose-100 border-red-100">
 <CardContent className="p-6">
 <div className="flex items-center gap-3 mb-4">
 ...
 <p className="text-sm text-gray-600">Potential Revenue Lost</p>
 </CardContent>
 </Card>

 <Card className="bg-gradient-to-br from-blue-50 to-cyan-100 border-blue-100">
 <CardContent className="p-6">
 <div className="flex items-center gap-3 mb-4">
 ...
 <h3 className="text-2xl font-bold text-gray-900">{stats.emailsSent}</h3>
 <p className="text-sm text-gray-600">Recovery Emails Sent</p>
 </CardContent>
 </Card>

 <Card className="bg-gradient-to-br from-green-50 to-emerald-100 border-green-100">
 <CardContent className="p-6">
 <div className="flex items-center gap-3 mb-4">
 ...
 <h3 className="text-2xl font-bold text-gray-900">{stats.recoveryRate.toFixed(1)}%</h3>
 ...
 className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-white text-gray-900 placeholder-gray-400"
 />
 </div>
 ...
 <th className="text-left py-3 px-4 font-medium text-gray-500">Cart Value</th>
 <th className="text-left py-3 px-4 font-medium text-gray-500">Abandoned</th>
 ...
 <tr key={cart.sessionId} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
 ...
 <div>
 <p className="font-medium text-gray-900">{cart.user.name ||'No name'}</p>
 ...
 <p className="text-xs text-gray-400">{cart.sessionId.slice(0, 8)}...</p>
 </div>
 </div>
 )}
 </td>
 ...
 <span className="text-gray-700">{cart.itemCount} item{cart.itemCount !== 1 ?'s' :''}</span>
 </div>
 </td>
 <td className="py-3 px-4">
 ...
 <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto m-4 border border-gray-200">
 <div className="p-6 border-b border-gray-200">
 <div className="flex items-center justify-between">
 <h2 className="text-xl font-bold text-gray-900">Cart Details</h2>
 <Button variant="outline" size="sm" onClick={() => setSelectedCart(null)} className="">
 Close
 </Button>
 </div>
 </div>
 ...
 <span className="font-medium text-gray-900">{selectedCart.user.name ||'Not provided'}</span>
 </div>
 <div className="flex justify-between">
 <span className="text-gray-500">Email:</span>
 <span className="font-medium text-gray-900">{selectedCart.user.email}</span>
 </div>
 </div>
 ) : (
 ...
 {/* Cart Items */}
 <div>
 <h3 className="font-semibold mb-3 text-gray-900">Cart Items ({selectedCart.items.length})</h3>
