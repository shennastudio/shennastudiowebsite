  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Button variant="outline" onClick={() => loadCarts()}>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredCarts.map((cart) => (
                    <tr key={cart.sessionId} className="border-b hover:bg-gray-50">
                      <td className="py-3 px-4">
                        {cart.user ? (
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <p className="font-medium">{cart.user.name || 'No name'}</p>
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto m-4">
            <div className="p-6 border-b">
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" onClick={() => setSelectedCart(null)}>
                  Close
                </Button>
              </div>
            </div>
            <div className="p-6 space-y-6">
                ...
                {selectedCart.user ? (
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{selectedCart.user.name || 'Not provided'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">Email:</span>
                      <span className="font-medium">{selectedCart.user.email}</span>
                    </div>
                  </div>
                ) : (
              ...
              {/* Cart Items */}
              <div>
                <h3 className="font-semibold mb-3">Cart Items ({selectedCart.items.length})</h3>
