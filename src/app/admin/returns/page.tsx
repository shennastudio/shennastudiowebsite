...
export default function ReturnsPage() {
 ...
 <Card className="bg-gradient-to-br from-gray-50 to-gray-100 border-slate-200">
 ...
 className="border border-gray-200 rounded-lg px-3 py-2 focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-white text-gray-900"
 >
 ...
 <Button variant="outline" onClick={() => loadReturns()} className="">
 ...
 <span className="font-mono text-sm text-gray-900">{returnItem.returnNumber.slice(0, 8)}</span>
 </td>
 <td className="py-3 px-4">
 <button
 ...
 <td className="py-3 px-4">
 <div>
 <p className="font-medium text-sm text-gray-900">{returnItem.customerName}</p>
 <p className="text-xs text-gray-500">{returnItem.customerEmail}</p>
 </div>
 </td>
 <td className="py-3 px-4">
 <span className="text-sm text-gray-700">{REASON_LABELS[returnItem.reason] || returnItem.reason}</span>
 </td>
 <td className="py-3 px-4">
 ...
 <div className="flex items-center justify-between">
 <div>
 <h2 className="text-xl font-bold text-gray-900">Return #{selectedReturn.returnNumber.slice(0, 8)}</h2>
 ...
 {/* Customer Info */}
 <div>
 <h3 className="font-semibold mb-2 text-gray-900">Customer Information</h3>
 ...
 {/* Return Reason */}
 <div>
 <h3 className="font-semibold mb-2 text-gray-900">Return Reason</h3>
 <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
 <p className="font-medium text-gray-900">{REASON_LABELS[selectedReturn.reason]}</p>
 ...
 {/* Items */}
 <div>
 <h3 className="font-semibold mb-2 text-gray-900">Return Items</h3>
 <div className="space-y-2">
 {selectedReturn.items.map((item) => (
 <div key={item.id} className="bg-gray-50 rounded-lg p-4 flex justify-between items-center border border-gray-100">
 <div>
 <p className="font-medium text-gray-900">{item.productName}</p>
 {item.variantName && <p className="text-sm text-gray-500">{item.variantName}</p>}
 <p className="text-sm text-gray-500">Qty: {item.quantity}</p>
 </div>
 <p className="font-medium text-gray-900">{formatCurrency(item.unitPrice * item.quantity)}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <Button variant="outline" onClick={() => setShowDetailModal(false)} className="">
 Close
 </Button>
 </div>
 </div>
