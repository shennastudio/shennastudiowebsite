...
export default function ReviewAutomationPage() {
 ...
 const [, setLogsDialogOpen] = useState(false);
 ...
 <div>
 <h1 className="text-2xl font-bold text-gray-900">Review Request Automation</h1>
 ...
 >
 <div>
 <p className="text-sm font-medium text-gray-900">{log.customerEmail}</p>
