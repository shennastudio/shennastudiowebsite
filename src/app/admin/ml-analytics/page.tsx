...
export default function MLAnalyticsPage() {
 ...
 <div>
 <p className="text-xs font-medium text-purple-600">Optimization Score</p>
 <p className="text-3xl font-bold text-purple-900">
 {insights?.stock_optimization.optimization_score.toFixed(1) || 0}%
 </p>
 <p className="text-xs text-purple-600 mt-1">AI-calculated efficiency</p>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-xs font-medium text-green-600">Avg Daily Demand</p>
 <p className="text-3xl font-bold text-green-900">
 {(insights?.forecasts.reduce((sum, f) => sum + f.avg_daily_demand, 0) || 0).toFixed(1)}
 </p>
 <p className="text-xs text-green-600 mt-1">units across all products</p>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-xs font-medium text-red-600">Low Stock Alerts</p>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-xs font-medium text-blue-600">Seasonal Index</p>
 ...
 <p className="text-xs text-blue-600 mt-1">current adjustment</p>
 </div>
 ...
 <TabsList className="grid w-full grid-cols-3 md:grid-cols-5 bg-gray-100 p-1 rounded-lg">
 <TabsTrigger value="forecast" className="data-[state=active]:bg-white rounded">
 <BarChart3 className="w-4 h-4 mr-2 hidden sm:block" />Forecast
 </TabsTrigger>
 <TabsTrigger value="reorder" className="data-[state=active]:bg-white rounded">
 <Package className="w-4 h-4 mr-2 hidden sm:block" />Reorder
 </TabsTrigger>
 <TabsTrigger value="trends" className="data-[state=active]:bg-white rounded">
 <TrendingUp className="w-4 h-4 mr-2 hidden sm:block" />Trends
 </TabsTrigger>
 <TabsTrigger value="seasonal" className="data-[state=active]:bg-white rounded">
 <Activity className="w-4 h-4 mr-2 hidden sm:block" />Seasonal
 </TabsTrigger>
 <TabsTrigger value="insights" className="data-[state=active]:bg-white rounded">
 ...
 <Card className="bg-white border-gray-200">
 <CardHeader>
 <CardTitle className="text-gray-900">Variant Forecasts</CardTitle>
 <CardDescription className="text-gray-600">
 ...
 <div key={forecast.variant_id} className="p-4 bg-gray-50 rounded-lg">
 ...
 <p className="font-semibold text-gray-900">{rec.current_stock} units</p>
 </div>
 <div>
 <p className="text-gray-500">Days Remaining</p>
 <p className={`font-semibold ${rec.days_remaining < 7 ?'text-red-600' :'text-gray-900'}`}>
 ...
 <div key={variant} className="p-4 bg-gray-50 rounded-lg text-center">
