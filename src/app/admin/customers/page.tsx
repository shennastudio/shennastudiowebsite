...
export default function CustomersPage() {
 ...
 className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md bg-white text-gray-900"
 />
 </div>
 </CardContent>
 </Card>
 ...
 <td className="py-4 font-medium text-gray-900">{customer.orderCount}</td>
 <td className="py-4 font-medium text-gray-900">${customer.totalSpent.toFixed(2)}</td>
 <td className="py-4 text-gray-900">${customer.avgOrderValue.toFixed(2)}</td>
 <td className="py-4">
