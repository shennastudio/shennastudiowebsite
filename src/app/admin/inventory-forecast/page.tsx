...
export default function InventoryForecastPage() {
 ...
 className="border border-gray-200 rounded-lg px-3 py-2 focus:ring-2 focus:ring-teal-500 bg-white text-gray-900"
 >
 <option value="7">Last 7 days</option>
 <option value="30">Last 30 days</option>
 <option value="90">Last 90 days</option>
 </select>
 <Button variant="outline" onClick={() => loadData()} className="">
 ...
 <div key={item.variantId} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg border border-gray-100">
 ...
 <p className="font-semibold text-gray-900">{item._sum.quantity} sold</p>
 ...
 <div className="text-right">
 <p className="font-semibold text-gray-900">{item.stock} in stock</p>
 ...
 <tr key={forecast.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
 ...
 <td className="py-3 px-4 font-mono text-sm text-gray-600">{forecast.sku}</td>
 <td className="py-3 px-4 font-semibold text-gray-900">{forecast.currentStock}</td>
 <td className="py-3 px-4 text-gray-700">{forecast.dailyAverage}</td>
 <td className="py-3 px-4 text-gray-700">{forecast.weeklyAverage}</td>
 <td className="py-3 px-4">
 {forecast.daysUntilOut !== null ? (
 <div className="flex items-center gap-2">
 <Clock className="w-4 h-4 text-gray-400" />
 <span className={forecast.daysUntilOut < 14 ?'text-red-600 font-medium' :'text-gray-700'}>
 ...
 <Button variant="outline" size="sm" onClick={markAllRead} className="">
