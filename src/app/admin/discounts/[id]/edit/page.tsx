...
export default function EditDiscountPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 className="w-full px-4 py-3 text-lg font-mono font-bold uppercase tracking-wider border-2 border-gray-200 rounded-xl bg-white focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all"
 ...
 onChange={handleChange}
 className={`w-full px-4 py-3 text-2xl font-bold border-2 border-gray-200 rounded-xl bg-white focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all ${
formData.type ==='FIXED_AMOUNT' ?'pl-10' :''
 ...
 onChange={handleChange}
 rows={2}
 className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-white focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all resize-none"
 ...
 onChange={handleChange}
 rows={2}
 className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-white focus:ring-4 focus:ring-gray-100 focus:border-gray-400 transition-all resize-none bg-gray-50"
 ...
 onChange={handleChange}
 className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-white focus:ring-4 focus:ring-green-100 focus:border-green-500 transition-all"
 ...
 onChange={handleChange}
 className="w-full px-4 py-3 pl-8 border-2 border-gray-200 rounded-xl bg-white focus:ring-4 focus:ring-green-100 focus:border-green-500 transition-all"
 placeholder="None"
 min="0"
 step="0.01"
 />
 ...
 onChange={handleChange}
 className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-white focus:ring-4 focus:ring-orange-100 focus:border-orange-500 transition-all"
 />
 </div>
 <div>
