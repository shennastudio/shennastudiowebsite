...
export default function EditDiscountPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Prepare data - use null for cleared optional fields to properly clear them on backend
      const discountData = {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <div>
        ...
        <h1 className="text-3xl font-bold tracking-tight">Edit Discount Code</h1>
        <p className="text-gray-600 mt-1">Update the promotional discount settings</p>
      </div>
