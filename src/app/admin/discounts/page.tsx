    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-gray-500">Avg/Code</p>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-gradient-to-br from-gray-50 to-white rounded-2xl border-2 border-dashed border-gray-300">
          ...
          <p className="text-gray-500 text-lg mb-4">No discount codes found</p>
          <button
            onClick={() => router.push('/admin/discounts/new')}
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {discounts.map((discount, index) => {
            ...
            return (
              <div
                key={discount.id}
                className={`group relative bg-white rounded-2xl border-2 overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${
                  expired ? 'border-gray-200 opacity-75' : config.border
                }`}
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <code className="text-lg font-bold text-gray-900 tracking-wide">
                            {discount.code}
                          </code>
                          <button
                    ...
                    {discount.isActive && !expired ? (
                      <span className="flex items-center gap-1 px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs font-semibold animate-pulse">
