...
export default function OrdersPage() {
 ...
 className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md text-sm bg-white text-gray-900"
 />
 </div>
 </div>
...
selectedOrders.has(order.id) ?'border-blue-400 bg-blue-50/50' :'border-gray-200'
 ...
 />
 <div>
 <p className="font-mono text-sm font-medium text-gray-900">#{order.orderNumber.slice(0, 8)}</p>
 ...
 <td className="py-4 font-mono text-sm text-gray-900">
