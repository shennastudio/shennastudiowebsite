...
'package': Package,
 ...
 {order.carrier && (
 <p className="text-sm text-gray-600">via {order.carrier}</p>
 )}
 </div>
 )}
 </CardContent>
 ...
 <div>
 <p className="text-sm text-gray-600 mb-1">Stripe Payment ID</p>
 <div className="flex items-center gap-2">
 ...
 className="w-full px-3 py-2 border border-gray-300 rounded-md resize-none bg-white text-gray-900"
 rows={3}
 />
