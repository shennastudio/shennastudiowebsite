...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      {/* Advertising Section for Fishing Businesses */}
      <section className="py-20 bg-gradient-to-br from-[#001F3F] via-[#002a4a] to-[#0a3a5a] relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#FF4500]/20 text-[#FF4500] px-4 py-1.5 rounded-full text-sm font-bold uppercase tracking-wider mb-6">
                <Anchor className="w-4 h-4" />
                Partner With Us
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tight uppercase">
                Advertise Your Fishing Business
              </h2>
              <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                Do you offer boat rides, fishing charters, or fishing-related services? 
                Reach thousands of anglers in South Texas without needing a developer team.
              </p>
            </motion.div>
          </div>
            ...
            {[
              {
                ...
                desc: "Fishing charters, boat tours, and guided trips",
                color: "text-cyan-400",
                bg: "bg-cyan-500/20"
              },
              {
                icon: Fish,
                title: "Boat Rentals",
                desc: "Kayaks, paddleboats, and fishing boat rentals",
              ...
              },
              {
                ...
                desc: "Photography, camping, and adventure experiences",
              ...
              >
                <div className={`w-14 h-14 ${category.bg} rounded-lg flex items-center justify-center mb-4`}>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-gradient-to-r from-[#FF4500] to-[#FF6B35] rounded-2xl p-8 md:p-12 text-center relative overflow-hidden"
          >
            {/* Decorative elements */}
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                We handle everything - from setup to updates. You just focus on your customers. 
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/contact">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="inline-flex items-center gap-2 bg-white text-[#001F3F] px-8 py-4 rounded-lg font-bold text-lg hover:bg-white/90 transition-all shadow-lg"
                  >
                    Get Started Today
                ...
                <Link href="/about">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="inline-flex items-center gap-2 border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-white/10 transition-all"
                  >
                    Learn More
                  </motion.button>
                </Link>
