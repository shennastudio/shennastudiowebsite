...
export const metadata: Metadata = {
  title: 'Privacy Policy | ShennaStudio',
  description: 'Privacy Policy for ShennaStudio. Learn how we collect, use, and protect your personal information.',
};
      ...
      <section className="py-16 -mt-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 space-y-8 text-gray-700 leading-relaxed">
            ...
            <p className="italic text-gray-500">Last Updated: March 2025</p>

            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">1. Introduction</h2>
              <p>
                Welcome to ShennaStudio. We are committed to protecting your personal information and your right to privacy.
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Communicate with you about our products, services, and conservation efforts</li>
                <li>Improve our website and customer service</li>
                <li>Process donations to our conservation partners (Sea Turtle Inc.)</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                However, please remember that no transmission of data over the Internet is 100% secure.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                If you have questions or comments about this Privacy Policy, please contact us at info@shennastudio.com.
              </p>
            </div>
