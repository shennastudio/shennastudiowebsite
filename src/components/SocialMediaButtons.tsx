...
const socialLinks = [
  {
    name: 'Instagram',
    href: 'https://instagram.com/shennastudio',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/shennastudio',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    name: 'TikTok',
    href: 'https://tiktok.com/@shennastudio',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    name: 'Pinterest',
    href: 'https://pinterest.com/shennastudio',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="bg-slate-900/70 px-3 py-2 border-t border-white/10">
              <button
                onClick={() => {
                  if (navigator.share) {
                    navigator.share({
                      title: "Shenna's Studio",
                      text: 'Check out these amazing ocean-inspired handcrafted bracelets! 10% supports marine conservation.',
