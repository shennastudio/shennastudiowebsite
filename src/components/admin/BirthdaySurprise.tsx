...
export function BirthdaySurprise() {
 ...
 <div className="bg-gradient-to-br from-pink-100 via-purple-100 to-cyan-100 rounded-3xl shadow-2xl p-8 sm:p-12 max-w-2xl w-full pointer-events-auto animate-scale-in border-4 border-white relative overflow-hidden">
 ...
 <h2 className="text-5xl sm:text-7xl font-black mb-6 text-pink-600 drop-shadow-lg">
 SHENNA!
 </h2>
