...
export function MobileTooltip({
 ...
 />
 <div className="absolute z-50 right-0 mt-2 w-72 p-4 bg-white rounded-xl shadow-2xl border border-slate-200 animate-in fade-in zoom-in-95 duration-200">
 {title && (
 ...
 <button
 onClick={() => setIsOpen(false)}
 className="mt-3 w-full py-2 text-sm font-medium text-slate-600 hover:text-slate-900 bg-slate-100 rounded-lg transition-colors"
 >
 Got it
 </button>
 </div>
